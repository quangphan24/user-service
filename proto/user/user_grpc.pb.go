...
type UserServiceClient interface {
	...
	GetBalance(ctx context.Context, in *String, opts ...grpc.CallOption) (*Amount, error)
}
...
func (c *userServiceClient) GetBalance(ctx context.Context, in *String, opts ...grpc.CallOption) (*Amount, error) {
	out := new(Amount)
...
type UserServiceServer interface {
	...
	GetBalance(context.Context, *String) (*Amount, error)
...
func (UnimplementedUserServiceServer) GetBalance(context.Context, *String) (*Amount, error) {
...
func _UserService_GetBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetBalance(ctx, req.(*String))
	}
	return interceptor(ctx, in, info, handler)
}
